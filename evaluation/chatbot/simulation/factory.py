...
def create_user_agent(
    ...
    execution_settings.function_choice_behavior = FunctionChoiceBehavior.Auto() # pyright: ignore[reportUnknownMemberType] As defined in Semantic Kernel SDK
...
def create_termination_strategy(
    ...
    termination_strategy = KernelFunctionTerminationStrategy(
        ...
        kernel=kernel,
        result_parser=lambda result: str(result.value[0]).lower() == "yes", # pyright: ignore[reportUnknownMemberType, reportUnknownArgumentType, reportUnknownLambdaType] As defined in Semantic Kernel SDK
